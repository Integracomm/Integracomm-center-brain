...
HELP: dict[str, list[tuple[str, str]]] = {
    ...
    "financeiro/visao": [
        ...
        ("Saúde da receita recorrente", "ISR (base ÷ base anterior ×100; >100 = crescendo) e Quick Ratio (nova ÷ perdida; >1 = repõe o churn) para B2-B5, Planos Antigos e consolidado — histórico e projeção. Mesma régua do bloco da Visão central."),
    ],
    "growth/carga": [
