...
HELP: dict[str, list[tuple[str, str]]] = {
    ...
    "prevendas/funil": [
        ...
        ("Oportunidades por bundle", "IMPORTANTE: o campo Produto (bundle) é preenchido na NEGOCIAÇÃO — não existe 'bundle do lead' na chegada. Esta tabela mostra o mix de bundle das oportunidades que os leads do período geraram, o % sobre o total de leads e a conversão em booking por bundle. Insights: (1) mix concentrado em B1 com meta em B3-B5 = topo desalinhado da prioridade; (2) se quiserem o bundle NA CHEGADA, é preciso criar um campo no formulário/Pipedrive (ex.: faixa de faturamento) — dá para automatizar depois."),
